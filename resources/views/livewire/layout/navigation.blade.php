...
<nav class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700" x-data="{ open: false }">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden items-center space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown class="" align="" width="48">
                        <x-slot name="trigger">
                            <button
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('tetapan.isu')" wire:navigate>
                                {{ __('Isu') }}
                            </x-dropdown-link>
